...
class THEMECOMPLETE_EPO_FIELDS_product extends THEMECOMPLETE_EPO_FIELDS {
	...
	public function display_field( $element = array(), $args = array() ) {
		...
		return array(
			...
			'show_title'                        => isset( $element['show_title'] ) ? $element['show_title'] : "1",
			'show_price'                        => isset( $element['show_price'] ) ? $element['show_price'] : "1",
			'show_description'                  => isset( $element['show_description'] ) ? $element['show_description'] : "1",
			'show_meta'                         => isset( $element['show_meta'] ) ? $element['show_meta'] : "1",
			'show_image'                        => isset( $element['show_image'] ) ? $element['show_image'] : "1",
